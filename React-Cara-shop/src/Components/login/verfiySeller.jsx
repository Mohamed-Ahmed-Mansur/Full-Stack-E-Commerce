...
const VerfiySellerLogin = () => {
  ...
  const maskedEmail = useSelector((state) => {
    ...
    return email
      ? `${email.substring(0, 2)} ${"*".repeat(email.length - 2)}@gmail.com`
      : "";
  });
            ...
            <div className="card p-2 text-center">
              ...
              >
                <input
                  ...
                  onChange={(e) => {
                    setVerificationCode(
                      e.target.value + verificationCode.slice(1)
                ...
                <input
                  ...
                  onChange={(e) => {
                    setVerificationCode(
                      verificationCode.slice(0, 1) +
                        e.target.value +
                        verificationCode.slice(2)
                    );
                    setIsInputWritten(e.target.value.length > 0);
                  }}
                />
                ...
                <input
                  ...
                  onChange={(e) => {
                    setVerificationCode(
                      verificationCode.slice(0, 4) +
                        e.target.value +
                        verificationCode.slice(5)
                    );
                    setIsInputWritten(e.target.value.length > 0);
                  }}
                />
