              ...
              <div className="container">
                ...
                <div className="row justify-content-evenly  mt-3" style={{ "textAlign": "left"}}>
                  ...
                  <FooterLogo className="logo" src="../assets/img/logo.png" alt="Logo" />
                    ...
                    <FooterParagraph><strong>Phone:</strong> +01 2222 365 / (+91) 01 2345 6789</FooterParagraph>
                    <FooterParagraph><strong>Hours:</strong> 10:00 - 18:00, Mon - Sat</FooterParagraph>
                ...
                <div className="row">
                  <div className="col">
                    <CopyrightContainer className="copyright">
                      <FooterHeader>© 2024, ITI - Made by : Mariam - Sara - Salma - Mohamed - Hossam - Mahmoud</FooterHeader>
                    </CopyrightContainer>
                  </div>
                </div>
              </div>
